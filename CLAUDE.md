...
npm test         # node --test "src/**/*.test.js"  — 202 tests, ~75ms, zero dependencies
```
...
```
src/
  NanaKnows.jsx     ~1410 lines: palette, three SVG illustrations, all state,
  ...
  i18n/en.js        134 keys
  i18n/es.js        134 keys, same shape
  *.test.js         parse 68, advice 69, wording 65
```
