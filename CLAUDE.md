...
npm test         # node --test "src/**/*.test.js"  — 160 tests, ~75ms, zero dependencies
```
...
```
src/
  NanaKnows.jsx     ~1050 lines: palette, three SVG illustrations, all state,
  ...
  i18n/en.js        100 keys
  i18n/es.js        100 keys, same shape
  *.test.js         parse 58, advice 49, wording 53
```
