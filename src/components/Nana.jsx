...
export function Nana({ size = 150, bob = true, label }) {
  return (
    ...
    >
      ...
      {/* buttons */}
      <circle cx="100" cy="154" r="3" fill={ART.butter} />
      <circle cx="100" cy="168" r="3" fill={ART.butter} />
      {/* bun */}
      <circle cx="100" cy="34" r="21" fill={ART.hair} />
      <path
      ...
      {/* face */}
      <circle cx="100" cy="82" r="38" fill={ART.skin} />
      {/* glasses */}
      ...
      {/* eyes */}
      <circle cx="83" cy="81" r="3.4" fill={ART.espresso} />
      <circle cx="117" cy="81" r="3.4" fill={ART.espresso} />
      {/* cheeks */}
      <circle cx="68" cy="96" r="6" fill={ART.cheek} opacity="0.8" />
      <circle cx="132" cy="96" r="6" fill={ART.cheek} opacity="0.8" />
      {/* smile */}
      <path
      ...
      />
      {/* yarn ball */}
      <circle cx="100" cy="180" r="21" fill={ART.rose} />
      <path d="M81 174 Q100 166 119 174" stroke={ART.roseDark} strokeWidth="2.5" fill="none" />
      <path d="M80 184 Q100 176 120 184" stroke={ART.roseDark} strokeWidth="2.5" fill="none" />
      <path d="M84 192 Q100 186 116 192" stroke={ART.roseDark} strokeWidth="2.5" fill="none" />
      {/* loose yarn tail */}
      <path
      ...
      />
      {/* hands */}
      <circle cx="82" cy="181" r="8.5" fill={ART.skin} />
      <circle cx="118" cy="181" r="8.5" fill={ART.skin} />
    </svg>
  );
}
