      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <label className="flex flex-col gap-1.5">
          ...
          <input
            ...
            value={fields.bust}
            onChange={(e) => setters.bust(e.target.value)}
            placeholder={ph.bust}
          />
        </label>
        <label className="flex flex-col gap-1.5">
          ...
          <select
            style={inputStyle}
            className="mt-auto px-3 py-2.5 text-sm nk-focus"
            value={fields.easeIdx}
            onChange={(e) => setters.easeIdx(Number(e.target.value))}
          >
            {easeOptions.map((o, i) => (
        ...
        <label className="flex flex-col gap-1.5">
          ...
          <input
            ...
            style={inputStyle}
            className="mt-auto px-3 py-2.5 text-sm"
            value={fields.myGauge}
            onChange={(e) => setters.myGauge(e.target.value)}
            placeholder={ph.myGauge}
          />
        </label>
        <label className="flex flex-col gap-1.5">
          ...
          <input
            ...
            style={inputStyle}
            className="mt-auto px-3 py-2.5 text-sm"
            value={fields.myRowGauge}
            onChange={(e) => setters.myRowGauge(e.target.value)}
            placeholder={ph.myRowGauge}
          />
        </label>
      </div>
      <SwatchHelper
